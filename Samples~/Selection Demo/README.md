...
Click a world object to select it through ObjectSelection. The ObjectSelection-CoreState bridge updates CoreState, and the GenericUIItems-CoreState bridge updates the UI list selected key. The UI list uses a GenericUIItems tint visual strategy for selected and normal rows.
